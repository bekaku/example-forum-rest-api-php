...
if(empty($voteData)){
    ...
    if($voteData['down_count']==1){
        $updateData['down_count'] = 0;
    }else{
        $updateData['down_count'] = 1;
    }
...
$database->bind(":user_account_id" , $userId);
$database->bind(":disuser_account_id" , $userId);
$database->bind(":user_comment" , $userId);
